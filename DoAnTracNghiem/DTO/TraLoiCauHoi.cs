...
namespace DoAnTracNghiem.DTO
{
    public class TraLoiCauHoi
    {
        ...
        public TraLoiCauHoi(DataRow row)
        {
        ...
        public TraLoiCauHoi(string noidungcauhoi, string a, string b, string c, string d, string answer)
        {
            stt += 1;
        ...
        public bool Dachon { get => dachon; set => dachon = value; }
    }
}
